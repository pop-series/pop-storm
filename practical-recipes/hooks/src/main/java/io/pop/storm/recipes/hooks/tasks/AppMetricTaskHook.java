...
public class AppMetricTaskHook extends BaseTaskHook implements Serializable {
    ...
    public void boltExecute(BoltExecuteInfo info) {
        ...
        final long srcEpoch = Long.valueOf(info.tuple.getStringByField(EventConstants.SRC_TIMESTAMP_MILLIS));
        final long currEpoch = System.currentTimeMillis();
        final String component = topologyContext.getComponentId(info.executingTaskId);
        appMetricRecorder.recordEventCumulativeTimeElapsed(new Labels.EventCumulativeTime(component), currEpoch - srcEpoch);
    }
}
